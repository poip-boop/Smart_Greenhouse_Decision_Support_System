...
#  Configuration 
intervals = 10
critical_alert_threshhold = 2  # consecutive intervals
MOISTURE_HISTORY_WINDOW = 3  # for moving average recommendation
...
def get_sensor_data():
    ...
    Returns a dict with Temperature (°C), Humidity (%), Light (lux), Soil Moisture (%), CO2 (ppm).
    """
    return {
